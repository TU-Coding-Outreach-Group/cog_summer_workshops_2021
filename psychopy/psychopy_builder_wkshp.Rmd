---
title: "PsychoPy Builder Tutorial, Temple COG Workshop 2021"
author: "Susan Benear"
...
INSERT SCREENSHOT9 HERE

### Routines for Presenting Stimuli
Now let's get started on the task! For this task, we want to present to participants an image of an animal, a text label of this animal's name, plus an audio recording of someone reading a fact about that animal. First, create a new routine called "Encoding" that comes afer your intro routine. You will eventually have routines for image, sound, and text (all selected from Stimuli on the right), like this:
INSERT SCREENSHOT10 HERE
...
INSERT SCREENSHOT19 HERE

We also need to colect participant responses, again setting allowed keys to only a and b, and storing the participant's response as well as the correct answer for that question from the .csv.
INSERT SCREENSHOT20 HERE

Finally, we need to create a loop that encompases both of these routines so that each repeat cycles through a fact question and its source question paired together. It should look like this:
INSERT SCREENSHOT21 HERE

...NReps should = 1 and the same .csv should be added in "Conditions."
INSERT SCREENSHOT22 HERE
...
INSERT SCREENSHOT23 AND SCREENSHOT24 HERE
