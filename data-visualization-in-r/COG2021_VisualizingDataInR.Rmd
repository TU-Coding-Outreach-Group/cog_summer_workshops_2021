---
title: "Coding Outreach Group Summer Workshop - Visualizing Data in R"
date: "07/08/2021"
author: 
  - name: "**Content creator: William J. Mitchell**"
output:   
  html_document:
    toc: true
    toc_float: true
    toc_depth: 2
    df_print: paged
    css: !expr here::here("data-visualization-in-r/style.css")
...
Introduction
======================================================================================================
[![](https://img.youtube.com/vi/5VwXuyEMvkg/0.jpg)](http://www.youtube.com/watch?v=5VwXuyEMvkg)


 0.0 An R Markdown Primer 
========================================================
[![](https://img.youtube.com/vi/2oSE1lw0yPo/0.jpg)](http://www.youtube.com/watch?v=2oSE1lw0yPo)
...
0.5. Workshop Setup 
===================================================
[![](https://img.youtube.com/vi/ZAcMEdByA8I/0.jpg)](http://www.youtube.com/watch?v=ZAcMEdByA8I)
...
```{r Setting Working Directory}
  Plots.Dir <- "C:/Users/Administrator/Google_Drive/COG/cog_summer_workshops_2021/data-visualization-in-r/Plots/"
``` 
...
```{r Loading First Dataframe}
   load("C:/Users/Administrator/Google_Drive/COG/cog_summer_workshops_2021/data-visualization-in-r/Dataframes/df1.rda")
```
...
====================================================================
[![](https://img.youtube.com/vi/Pj1JyGk5WIo/0.jpg)](http://www.youtube.com/watch?v=Pj1JyGk5WIo)
...
=====================================================================
[![](https://img.youtube.com/vi/IoSv3LqeRgo/0.jpg)](http://www.youtube.com/watch?v=IoSv3LqeRgo)
...
======================================================
[![](https://img.youtube.com/vi/MgbiDmwX9e4/0.jpg)](http://www.youtube.com/watch?v=MgbiDmwX9e4)
...
===============================================================================
[![](https://img.youtube.com/vi/nRgg--HVYzI/0.jpg)](http://www.youtube.com/watch?v=nRgg--HVYzI)
...
====================================================================================================
[![](https://img.youtube.com/vi/4QLY2QVWdZQ/0.jpg)](http://www.youtube.com/watch?v=4QLY2QVWdZQ)
...
```{r Loading Second Dataframe}
   load("C:/Users/Administrator/Google_Drive/COG/cog_summer_workshops_2021/data-visualization-in-r/Dataframes/df2.rda")
```
...
======================================================================================================
[![](https://img.youtube.com/vi/NL5HMcqQHVc/0.jpg)](http://www.youtube.com/watch?v=NL5HMcqQHVc)
...
```{r Loading Third Dataframe}
   load("C:/Users/Administrator/Google_Drive/COG/cog_summer_workshops_2021/data-visualization-in-r/Dataframes/df3.rda")
```
...
Conclusion
======================================================================================================
[![](https://img.youtube.com/vi/STD5FyPiyYA/0.jpg)](http://www.youtube.com/watch?v=STD5FyPiyYA)
